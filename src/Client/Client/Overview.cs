...
namespace login
{
    public partial class Overview : Form
    {
        ...
        public Overview(HttpClient httpClient)
        {
            ...
            _http = httpClient;
            Loader();
            this.BackColor = System.Drawing.Color.FromArgb(16, 20, 20); // The dark background of the entire UI

            // *** ADD THIS LINE TO SET THE CHARTPANEL'S BACKGROUND ***
        ...
        private async void Loader()
        {
            ...
            this.Controls.Add(ovChart); // Chart added to the main form
        }
